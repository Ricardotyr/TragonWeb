# Generated by Django 4.0 on 2022-10-04 02:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_imagen', models.CharField(db_column='Nombre_Imagen', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Proveedor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precioventa', models.CharField(db_column='PrecioVenta', max_length=50)),
                ...
                ('imagen_id_imagen', models.ForeignKey(db_column='IMAGEN_ID_Imagen', on_delete=django.db.models.deletion.DO_NOTHING, to='TragonBall.imagen')),
            ],
        ),
        migrations.CreateModel(
            name='Permiso',
            fields=[
                ('id_permiso', models.IntegerField(db_column='ID_Permiso', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='MateriaPrima',
            fields=[
                ('id_materiaprima', models.IntegerField(db_column='ID_MateriaPrima', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='DetalleVenta',
            fields=[
                ('id_detalleventa', models.IntegerField(db_column='ID_DetalleVenta', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='DetalleCompra',
            fields=[
                ('id_detallecompra', models.IntegerField(db_column='ID_DetalleCompra', primary_key=True, serialize=False)),
